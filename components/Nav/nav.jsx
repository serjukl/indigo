...
const Nav = () => {
    const[isNavOpen, isNavOpenHandler] = useState(false)
    const links = [
        {
            name: 'Головна',
            link: '/'
    ...
    return (
        <nav className={styles.nav}>
            ...
            <ul className={isNavOpen ? styles.mobOpen : null}>
                {
                    links.map((link, key) => {
                        return (
                            <li key={key}>
                                <Link href={link.link}>
                                    <a onClick={() => isNavOpenHandler(false)}>
                                        { link.name }
                                    </a>
                                </Link>
                            </li>
            ...
            <div className={styles.navigationIcons}>
                {
                    isNavOpen
                        ? <svg onClick={() => isNavOpenHandler(!isNavOpen)} width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">

    ...
    return (
        <div className={styles.goods}>
            ...
            <div className={styles.imageGood}>
                <img src={props.item.src} alt={'Товари компанії INDIGO EXPERT'}/>
            </div>
            <h2>{props.item.title}</h2>
            <p style={{height: !flagMore ? '27px' : 'auto'}}>
                {props.item.text}
            </p>
            <div className={styles.more}>
                <button onClick={() => flagMoreHandler(!flagMore)}>
                {!flagMore ? 'Дізнатися більше' : 'Приховати'}
                </button>
